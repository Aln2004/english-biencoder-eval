#!/bin/bash
# Cross-Lingual Evaluation: french model/queries -> dutch corpus
# This script evaluates the french-trained Bi-Encoder on the dutch corpus
...
python cross-lingual/common_code/retriever/biencoder_training.py \
    ...
    --log_steps 1 \
    --do_save \
    --output_dir "cross-lingual/french_to_dutch/results" \
    --do_test
