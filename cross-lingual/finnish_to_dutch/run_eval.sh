#!/bin/bash
# Cross-Lingual Evaluation: finnish model/queries -> dutch corpus
# This script evaluates the finnish-trained Bi-Encoder on the dutch corpus
...
CORPUS_PATH="/home/btech/cbot_bleu/dutch/data/lleqa/dutch_articles.json"
...
python cross-lingual/common_code/retriever/biencoder_training.py \
    ...
    --log_steps 1 \
    --do_save \
    --output_dir "cross-lingual/finnish_to_dutch/results" \
    --do_test
