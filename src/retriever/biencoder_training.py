...
def main(args):
    ...
    import pickle
    print("Dumping the data variable to: data_pickle_output/datasetout.pickle ")
    with open("data_pickle_output/datasetout.pickle", "wb") as dataset_file:
    ...
    # Training disabled as per instructions.
